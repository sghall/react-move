...
var _self = 'undefined' != typeof window
  ? window
  : 'undefined' != typeof window.WorkerGlobalScope &&
...
!(function() {
  ...
  function n(e, n, i) {
    for (
      ...
      ;(h.textContent = Array(m - u + 2).join(' \n')), h.setAttribute(
        'aria-hidden',
        'true'
      ), (h.className = (i || '') + ' line-highlight'), t(e, 'line-numbers') ||
        (h.setAttribute('data-start', u), m > u &&
          h.setAttribute('data-end', m)), (h.style.top =
        (u - l - 1) * c + 'px'), t(e, 'line-numbers')
        ? e.appendChild(h)
  ...
  function i() {
    ...
    if (i && !document.getElementById(t)) {
      ...
      o &&
        (o.hasAttribute('data-line') || o.setAttribute('data-line', ''), n(
          o,
          i,
          'temporary '
  ...
  if (
    ...
    var r = (function() {
      ...
      return function() {
        if ('undefined' == typeof e) {
          ...
          ;(t.style.fontSize = '13px'), (t.style.lineHeight =
            '1.5'), (t.style.padding = 0), (t.style.border = 0), (t.innerHTML =
            '&nbsp;<br />&nbsp;'), document.body.appendChild(t), (e =
            38 === t.offsetHeight), document.body.removeChild(t)
        }
        return e
      }
    })(),
    ...
    Prism.hooks.add('complete', function(t) {
      ...
      r &&
        ...
        (clearTimeout(o), e('.line-highlight', r).forEach(function(e) {
          e.parentNode.removeChild(e)
